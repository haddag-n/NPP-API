...
class Medicament(Base):
    ...
    dci = Column(String(500), nullable=False, index=True)
    nom_marque = Column(String(500), nullable=False, index=True)
    forme = Column(String(500), nullable=False)
    dosage = Column(String(255), nullable=False)
    conditionnement = Column(String(255), nullable=False)
    ...
    laboratoire = Column(String(500), nullable=False, index=True)
    ...
    duree_stabilite = Column(String(255), nullable=True)
